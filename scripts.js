...
document.addEventListener('mousemove', function (e) {
    ...
    // You can change the emoji here:
    trail.textContent = '🩷'; // or '🦋', '🌸'
...
// Falling hearts effect (uncomment the CCS to see the effect) ---------------------------------------------------------------------------------
function createHeart() {
    ...
    const duration = 30; // 4–7s
    heart.style.animationDuration = duration + 's';

    // Click to pop
    heart.addEventListener('click', () => {
      heart.style.animation = 'pop 0.4s ease-out forwards';
